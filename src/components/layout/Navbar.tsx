      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 h-16 transition-all duration-200 ${
          scrolled
            ...
            : "bg-white/40 backdrop-blur-xs border-b border-slate-200/40"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex items-center justify-between h-full">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link
              href="#platform"
              className="text-xs font-semibold text-slate-600 hover:text-slate-950 transition-colors uppercase tracking-wider"
            >
              Platform
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center gap-5">
            <button
              ...
              className="text-xs font-bold text-slate-700 hover:text-slate-950 transition-colors px-3 py-2 cursor-pointer uppercase tracking-wider"
            >
              Log In
            </button>
            <button
          ...
          <div className="md:hidden bg-white border-b border-slate-200 px-6 py-5 space-y-4 shadow-lg absolute top-16 left-0 right-0">
            <nav className="flex flex-col gap-3">
              <Link
                ...
                className="text-sm font-semibold text-slate-700 hover:text-slate-950 uppercase tracking-wider"
              >
                Platform
              </Link>
              <Link
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-col gap-2.5">
              <button
                onClick={() => triggerModal("User & Owner Log In")}
                className="w-full text-center text-xs font-bold text-slate-700 py-2 rounded-md hover:bg-slate-50 cursor-pointer uppercase tracking-wider"
              >
                Log In
              </button>
              <button
